    ...
    <div className="flex flex-col xl:flex-row items-center justify-between gap-2">
      <div className="form-contol w-full">
        ...
        <select
          ...
          className={`select select-sm select-bordered w-full ${errors.cancelAuthority && "select-error"}`}
          onChange={handler}
        >
      ...
      <div className="form-contol w-full">
        ...
        <select
          ...
          className={`select select-sm select-bordered w-full ${errors.changeRecipientAuthority && "select-error"}`}
          onChange={handler}
        >
          <option value={Authority.Neither}>No One</option>
          <option value={Authority.Funder}>Only Funder</option>
